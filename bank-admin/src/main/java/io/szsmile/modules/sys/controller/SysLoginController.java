...
import io.szsmile.modules.sys.form.SysLoginForm;
import io.szsmile.modules.sys.service.SysCaptchaService;
...
public class SysLoginController extends AbstractController {
	...
	public Map<String, Object> login(@RequestBody SysLoginForm form)throws IOException {
        ...
        logger.info("SysLoginForm:{}",form.toString());
		...
		//生成token，并保存到数据库  TODO token为为什么保存到数据库？？？ 数据库token表结构，该表结构改成redis即可实现sso单点登入功能
