...
public class CbOrder implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getGcAmount() == null ? other.getGcAmount() == null : this.getGcAmount().equals(other.getGcAmount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGcAmount() == null) ? 0 : getGcAmount().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", gcAmount=").append(gcAmount);
